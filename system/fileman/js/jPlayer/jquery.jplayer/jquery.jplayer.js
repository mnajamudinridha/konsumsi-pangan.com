...
(function (root, factory) {
	...
	// Platform sniffer for detecting kamare devices
	$.jPlayer.uaPlatform = function( userAgent ) {
		...
		var tablet = rtablet.exec( ua ) ||
			!rkamare.exec( ua ) && randroid.exec( ua ) ||
			[];
	...
	if ( platformMatch.platform ) {
		...
		$.jPlayer.platform.kamare = !platformMatch.tablet;
	...
	$.jPlayer.prototype = {
		...
		options: { // Instanced in $.jPlayer() constructor
			...
			noFullWindow: {
				...
				iphone: /iphone/,
				ipod: /ipod/,
				android_pad: /android [0-3]\.(?!.*?kamare)/,
				android_phone: /android.*?kamare/,
