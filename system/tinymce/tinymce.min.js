...
! function(e, t) {
    ...
    r(l, [], function() {
        ...
        })), i.ie && i.ie < 9 && (D["float"] = "styleFloat", C(L, "set", {
            ...
            function o(o) {
                ...
                function g(t) {
                    ...
                    if (t) {
                        ...
                        } else "BR" == t.nodeName ? t.nextSibling && a.isBlock(t.nextSibling) ? ((!L || 9 > L) && (u = a.create("br"), t.parentNode.insertBefore(u, t)), l.setStartBefore(t), l.setEndBefore(t)) : (l.setStartAfter(t), l.setEndAfter(t)) : (l.setStart(t, 0), l.setEnd(t, 0));
                ...
                var T, R, A, B, D, M, L, H, P, O, I, F, z, W, V;
                if (T = s.getRng(!0), !o.isDefaultPrevented()) {
                    if (!T.collapsed) return void i.execCommand("Delete");
                    if (new t(a).normalize(T), B = T.startContainer, D = T.startOffset, W = (l.force_p_newlines ? "p" : "") || l.forced_root_block, W = W ? W.toUpperCase() : "", L = a.doc.documentMode, H = o.shiftKey, 1 == B.nodeType && B.hasChildNodes() && (V = D > B.childNodes.length - 1, B = B.childNodes[Math.min(D, B.childNodes.length - 1)] || B, D = V && 3 == B.nodeType ? B.nodeValue.length : 0), A = N(B)) {
                        if (c.beforeChange(), !a.isBlock(A) && A != a.getRoot()) return void((!W || H) && _());
                        if ((W && !H || !W && H) && (B = C(B, D)), M = a.getParent(B, a.isBlock), I = M ? a.getParent(M.parentNode, a.isBlock) : null, F = M ? M.nodeName.toUpperCase() : "", z = I ? I.nodeName.toUpperCase() : "", "LI" != z || o.ctrlKey || (M = I, F = z), /^(LI|DT|DD)$/.test(F)) {
                            if (!W && H) return void _();
                            if (a.isEmpty(M)) return void w()
                        }
                        if ("PRE" == F && l.br_in_pre !== !1) {
                            if (!H) return void _()
                        } else if (!W && !H && "LI" != F || W && H) return void _();
                        W && M === i.getBody() || (W = W || "P", x() ? k() : x(!0) ? (P = M.parentNode.insertBefore(b(), M), p(P), g(M)) : (R = T.cloneRange(), R.setEndAfter(M), O = R.extractContents(), E(O), P = O.firstChild, a.insertAfter(O, M), m(P), S(M), a.isEmpty(M) && y(M), a.isEmpty(P) ? (a.remove(P), k()) : g(P)), a.setAttrib(P, "id", ""), i.fire("NewBlock", {
                            newBlock: P
                        }), c.add())
                    }
                }
            ...
            v = {
                ...
                repaint: function() {
                    ...
                    c = document.createRange ? function(e) {
                            return e
                        } : Math.round, t = e.getEl().style, i = e._layoutRect, l = e._lastRepaintRect || {}, o = e.borderBox, a = o.left + o.right, s = o.top + o.bottom, i.x !== l.x && (t.left = c(i.x) + "px", l.x = i.x), i.y !== l.y && (t.top = c(i.y) + "px", l.y = i.y),
        ...
        return function(s) {
            ...
            var q = a.each,
                ...
                ie = te ? "Text" : "URL";
            S(), m(), H(), ne && (p(), v(), x(), R(), V(), _(), U(), o.iOS ? (O(), I(), W()) : g()), te && o.ie < 11 && (y(), w(), E(), N(), B(), D(), M(), L()), o.ie >= 11 && (I(), _()), o.ie && (g(), z(), $()), ee && (y(), b(), C(), k(), T(), A(), P(), F(), _())
        }
        ...
        function e(e) {
            ...
            function c(e) {
                var t;
                return "object" == typeof e ? "r" in e ? (d = e.r, f = e.g, h = e.b) : "v" in e && o(e.h, e.s, e.v) : (t = /rgb\s*\(\s*([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+)[^\)]*\)/gi.exec(e)) ? (d = parseInt(t[1], 10),
        ...
        return e.extend({
            renderHtml: function() {
                var e = this;
                return e.classes.add("spacer"), e.canFocus = !1,
