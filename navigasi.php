      ...
      <div class="list-group">
        ...
        if (isset($_SESSION['login'])) {
            if ($_SESSION['login'] == 'admin') {
              ...
              <a href="index.php?menu=konsumsi" class="list-group-item">Data Konsumsi</a>
              <br>
              Data Website<br><br>
            ...
            <br><br>
            Menu PPH<br><br>
            <a href="index.php?menu=tingkatkecukupan" class="list-group-item">Tingkat Kecukupan</a>
            <a href="index.php?menu=kontribusienergi" class="list-group-item">Kontribusi Energi</a>
            <br><br>
            Menu Akun<br><br>
